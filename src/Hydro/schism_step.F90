...
!$OMP   do
  ...
  call exchange_p2d(tau_oix)
  call exchange_p2d(tau_oiy)
...
!
!        tau_oix(i) = aux*(uvice(i) - uu2(nvrt,i))
!        tau_oiy(i) = aux*(vvice(i) - vv2(nvrt,i))
!    else
!        tau_oix(i) = real(0.0)
!        tau_oiy(i) = real(0.0)
!    endif
  ...
  do i = 1,npa
    if (aice(i) > real(1e-8)) then
      ...
      !>-------------------------------------------------
        ...
        tau(1,i)   = (1-aice(i))*tau(1,i) + aice(i)*(tau_oix(i)/real(1025.0)) 
        tau(2,i)   = (1-aice(i))*tau(2,i) + aice(i)*(tau_oiy(i)/real(1025.0))
      !>-------------------------------------------------
      !>Fresh water flux 
      ...
      !>-------------------------------------------------
      !>Scaling the evaporation flux to deal with ice ??
